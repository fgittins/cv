...
Relativistic astrophysics, fluid dynamics and dense nuclear matter. Probing
the extreme physics of neutron stars with gravitational waves.

\section{Grants and Awards}

\textbf{Marie Sk{\l}odowska-Curie Postdoctoral Fellow,} European Union
...
\begin{itemize}
    \item[ ]
    Postdoctoral project, University of Namur, BE
    \hfill \textbf{2025}
    \item[ ]
    Open Fellowship, Engineering and Physical Sciences Research Council, UK
    \hfill \textbf{2024}
\end{itemize}
...
Intermediate in Bash, C++, \textsc{Mathematica}, MATLAB.
