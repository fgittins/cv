...
\secstartswithlist{}%
\begin{etaremune}
    \item \textit{Astrophysics Talks Series},
    Istanbul University Observatory, TR (online)
    \hfill \textbf{2 Apr 2026}
    %
    ...
    Institute of Cosmology and Gravitation, University of Portsmouth, GB
    %
    ...
    %
    \item \textit{22nd BritGrav Conference}, University of Glasgow, GB (online)
...
27 contributed talks at 25 separate conferences and meetings, including:
%
\vspace*{0.05in}
\begin{etaremune}
    ...
    and \textit{16th Edoardo Amaldi Conference on Gravitational Waves}, Glasgow, GB
    %
    ...
    \hfill \textbf{6--7 May 2024}
    %
    \item \textit{SPINS-UK 2023 meeting}, 
    Magdalen College, University of Oxford, GB \hfill \textbf{23 Nov 2023}
    %
