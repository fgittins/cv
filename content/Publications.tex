...
% TODO: Update for each new publication
...
Excluding long-author-list papers.
Citation counts according to Google Scholar.
%
\vspace*{0.05in}
\begin{enumerate}
    ...
    \citeCount{52}
    %
    \item Pereira, J.~P., Bejger, M., Andersson, N., \textbf{Gittins, F.},
...
Since 2026, I have been a co-author of refereed LIGO-Virgo-KAGRA and
Einstein Telescope Collaboration publications.
I list only non-collaboration articles below.
...
\begin{etaremune}[start=\value{pubCounter}]
    ...
    %
    \item Yu, H. et al.,
    \textit{Nonlinear hydrodynamics in spinning neutron stars: Theoretical
    universal relations and equilibrium solutions}
    \arxiv{2607.07943}.
    %
    \item Negri, L. et al.,
    \textit{Impact of the Einstein Telescope's duty cycle on the estimation of
...
\begin{etaremune}[start=\value{pubCounter}]
    \renewcommand\labelenumi{[\theenumi]}
    %
    \item \textbf{Gittins, F.} et al.,
    \textit{Detecting tidal resonances in binary neutron stars},
    \href{https://doi.org/10.1103/51xv-gfy9}{\prl}
    \arxiv{2606.06376}.
    %
    \setcounter{pubCounter}{\value{enumi}}
\end{etaremune}
...
\begin{etaremune}[start=\value{pubCounter}]
    ...
    \textit{Tidal response of a relativistic star},
    \href{https://doi.org/10.1103/x4yr-x1c4}%
    {\prd\ \textbf{113}, 064051 (2026)}
    \arxiv{2511.05139}.
    %
    \item Yin, S., Andersson, N., \textbf{Gittins, F.},
    \textit{A post-Newtonian approach to neutron star oscillations},
    \href{https://doi.org/10.1088/1361-6382/ae1c16}%
    {\cqg\ \textbf{42}, 235002 (2025)}
    \arxiv{2504.06918}.
    %
    ...
    \arxiv{2508.06416}.
    %
    \item Counsell, A.~R., \textbf{Gittins, F.} et al.,
    ...
    \arxiv{2310.13586}.
    %
    \item Pnigouras, P., \textbf{Gittins, F.} et al.,
    ...
    \arxiv{2212.04837}.
    %
    \item Andersson, N., \textbf{Gittins, F.} et al.,
...
\begin{etaremune}[start=\value{pubCounter}]
    \renewcommand\labelenumi{[\theenumi]}
    %
    \item Thomas, A. Stevenson, E., \textbf{Gittins, F.} et al.,
...
\begin{etaremune}[start=\value{pubCounter}]
    \renewcommand\labelenumi{[\theenumi]}
    %
    \item Dietrich, T. et al.,
    \textit{ESO Expanding Horizon White Paper: Revealing the properties of matter at supranuclear densities with gravitational waves}
    \arxiv{2512.16971}.
    %
    \setcounter{pubCounter}{\value{enumi}}
\end{etaremune}
