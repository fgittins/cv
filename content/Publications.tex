...
\begin{etaremune}[start=\value{pubCounter}]
    ...
    \textit{Impact of the Einstein Telescope's duty cycle on the estimation of binary black holes parameters}
    \arxiv{2606.19201}.
    \citeCount{0}
    %
    \item \textbf{Gittins, F.}, Narola, H., Wouters, T., Pang, P.~T.~H., Hinderer, T., Van Den Broeck, C.,
